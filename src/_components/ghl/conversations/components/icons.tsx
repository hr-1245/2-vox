...
export function EmailIcon({ size = 14, className = '' }: IconProps) {
  return (
    <svg 
...
export function VectorIcon({ size = 14, className = '' }: IconProps) {
  return (
    <svg 
      xmlns="http://www.w3.org/2000/svg" 
      width={size} 
...
export function LoadingSpinner({ size = 14, className = '' }: IconProps) {
  return (
    <svg 
      xmlns="http://www.w3.org/2000/svg" 
      width={size} 

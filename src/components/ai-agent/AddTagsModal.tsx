...
export default function AddTagsModal({ ghlTags, editing,setTags,tags,setNewTag,handleAddTag,newTag }: AddTagsModalProps) {
    ...
    {newTag && (
      <div className="border rounded-lg shadow bg-white max-h-40 overflow-y-auto mb-3">
        ...
        {!tags.some((t) => t.toLowerCase() === newTag.toLowerCase()) && (
          <div
            className="px-3 py-2 cursor-pointer bg-blue-50 text-blue-600 hover:bg-blue-100"
